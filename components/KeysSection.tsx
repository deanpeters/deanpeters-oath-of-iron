...
const KeyCard: React.FC<KeyCardProps> = ({ icon, title, description }) => (
  <div className="bg-oath-surface border border-oath-border rounded-xl p-8 space-y-6 transition-all duration-300 hover:-translate-y-2 gold-border-glow group">
